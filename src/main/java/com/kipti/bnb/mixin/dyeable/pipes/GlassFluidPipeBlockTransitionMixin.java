...
public class GlassFluidPipeBlockTransitionMixin {
    ...
    @WrapOperation(
            method = "onWrenched",
            at = @At(value = "INVOKE", target = "Lcom/zurrtum/create/content/fluids/FluidTransportBehaviour;cacheFlows(Lnet/minecraft/world/level/LevelAccessor;Lnet/minecraft/core/BlockPos;)V")
    )
    ...
    @WrapOperation(
            method = "onWrenched",
            at = @At(value = "INVOKE", target = "Lcom/zurrtum/create/content/fluids/FluidTransportBehaviour;loadFlows(Lnet/minecraft/world/level/LevelAccessor;Lnet/minecraft/core/BlockPos;)V")
    )
