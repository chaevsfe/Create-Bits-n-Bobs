...
public class GayDye {
    ...
    public static GayDye read(final CompoundTag tag) {
        final int animationTick = tag.getIntOr("GayDyeAnimationTick", 0);
        final int animationTypeOrdinal = tag.getIntOr("GayDyeAnimationType", 0);
        final int prideTypeOrdinal = tag.getIntOr("GayDyePrideType", 0);
