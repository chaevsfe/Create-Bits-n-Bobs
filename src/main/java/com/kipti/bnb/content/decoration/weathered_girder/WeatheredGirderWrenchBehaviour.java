...
/**
 * Exact mirror pretty much of {@link WeatheredGirderWrenchBehaviour} but with the occasional reference changed to the weathered variant
 */
public class WeatheredGirderWrenchBehaviour {
