...
public class ChainIdMigrations {
    ...
    public static final Identifier BNB_SIMPLE_KINETIC =
            CreateBitsnBobs.asResource("simple_kinetic");
    public static final Identifier MIGRATING_SIMPLE_KINETIC =
     ...
     */
    public static final Map<Identifier, Identifier> BLOCK_RENAMES = Map.of(
            CreateBitsnBobs.asResource("small_cogwheel_chain"), Identifier.fromNamespaceAndPath("create", "cogwheel"),
            CreateBitsnBobs.asResource("large_cogwheel_chain"), Identifier.fromNamespaceAndPath("create", "large_cogwheel"),
     ...
     */
    public static final Identifier COGWHEEL_CHAIN_BE = CreateBitsnBobs.asResource("cogwheel_chain");

    /**
     * Unambiguous block entity renames (target independent of which block they sit on, later differentiation may occur).
     */
    public static final Map<Identifier, Identifier> BLOCK_ENTITY_RENAMES = Map.of(
