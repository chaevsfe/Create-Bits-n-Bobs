...
public class CogwheelChainGeometryBuilder {
    ...
    private static List<RenderedChainPathNode> wrappedArcBetweenPoints(
        ...
        final Vec3 center = Vec3.atCenterOf(currentNode.localPos());
...
//            Vec3 otherAxis = Vec3.atLowerCornerOf(Direction.fromAxisAndDirection(other, Direction.AxisDirection.POSITIVE).getUnitVec3i());
